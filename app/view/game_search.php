<?php
$cari = $_POST['cari'];
$result = $db->query("select * from game a, genre b, publisher c, member d where a.genre_id = b.genre_id and a.publisher_id = c.publisher_id and a.member_id = d.member_id and a.games_name like '%".$cari."%'");
?>
<fieldset>
	<legend>Games</legend>
